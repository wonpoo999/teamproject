  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === 'ios' ? 80 : 0}>
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: 20, gap: 12, flexGrow: 1, justifyContent: 'center' }}>
        ...
        <TextInput value={id} onChangeText={setId} placeholder="ID" autoCapitalize="none" autoCorrect={false} textContentType="username" style={{ borderWidth: 1, borderColor: '#ddd', borderRadius: 10, padding: 12 }} returnKeyType="next" />
        <TextInput value={password} onChangeText={setPassword} placeholder="Password" secureTextEntry textContentType="password" style={{ borderWidth: 1, borderColor: '#ddd', borderRadius: 10, padding: 12 }} returnKeyType="done" onSubmitEditing={onSubmit} />
