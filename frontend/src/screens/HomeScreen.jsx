...
const styles = StyleSheet.create({
  ...
  boxText: { fontSize: BOX_FONT, height: BOX_HEIGHT, color: '#333', fontFamily: FONT, includeFontPadding: true, lineHeight: BOX_FONT * 1.25 },
  ...
  gaugeText: { color: 'gray', fontSize: 12, fontFamily: FONT, includeFontPadding: true, lineHeight: 16 },
  labelText: { fontSize: 18, marginTop: -2, fontFamily: FONT, color: 'tomato', includeFontPadding: true, lineHeight: 22, textAlign: 'center' }
});
