...
import { View, Text, ImageBackground, StyleSheet, Animated, Platform, AppState, Linking } from 'react-native'
...
const styles=StyleSheet.create({
  ...
  hint:{fontFamily:FONT,fontSize:12,color:'#666',textAlign:'center',marginTop:6},
  subCard:{backgroundColor:'rgba(255,255,255,0.75)',borderRadius:20,padding:16,gap:8},
  subTitle:{fontFamily:FONT,fontSize:18,color:'#111'},
  subRow:{flexDirection:'row',justifyContent:'space-between'},
  subKey:{fontFamily:FONT,fontSize:14,color:'#333'},
  subVal:{fontFamily:FONT,fontSize:14,color:'#111'}
})
