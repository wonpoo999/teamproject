...
export default function SignupScreen({navigation}){
  ...
  const onSubmit=async()=>{
    if(!id||!password||!weight||!age||!gender||!height){ Alert.alert('필수 입력'); return }
  ...
  return (
    <View style={{flex:1,justifyContent:'center',padding:20,gap:12}}>
      ...
      <View style={{flexDirection:'row',gap:8}}>
        <TouchableOpacity onPress={()=>setGender('female')} style={{flex:1,backgroundColor:gender==='female'?'#111827':'#e5e7eb',padding:12,borderRadius:10}}>
      ...
      <TouchableOpacity onPress={onSubmit} style={{backgroundColor:'#10b981',padding:14,borderRadius:10}}>
