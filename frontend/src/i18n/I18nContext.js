...
const DICT = {
  ko: {
    ...
    ERR_NO_USER: '존재하지 않는 아이디입니다.',
    ERR_FORBIDDEN: '접근 권한이 없습니다.',
    ERR_INVALID_CRED: '아이디 또는 비밀번호가 올바르지 않습니다.',
    ...
    QUESTION_CHILDHOOD_AREA: '어린 시절 살던 동네는?',
    QUESTION_PET_NAME: '내 애완동물 이름은?',
    QUESTION_MOTHER_NAME: '내 어머니의 이름은?',
    QUESTION_ROLE_MODEL: '나의 롤모델은 누구인가?',
  },
  ...
  en: {
    ...
    PASSWORD_8: 'Password (min 8 chars)',
    ...
    VOICE_PICK: 'Voice selection',
    USE_DEFAULT_VOICE: 'Use default voice',
    PREVIEW: 'Preview',
    SELECT: 'Select',
    ALL: 'All',
    DAILY_QUESTS: 'Today’s daily quests',
    WALK: 'Walk',
    START_SQUAT: 'Start squat',
    START_PUSHUP: 'Start push-up',
    RESET_QUESTS: 'Reset quests',
    RECOVERY: 'Password recovery',
    RECOVERY_SETUP: 'Security Q&A',
    SECURITY_QNA: 'Security Q&A',
    SECURITY_QNA_OPTIONAL: 'Security Q&A (optional)',
    SECURITY_DESC_SIGNUP: 'Answer any questions you like. We recommend at least two.',
    ...
    RECOVERY_START_DESC_ID: 'ID recovery requires all 5 answers to be registered.',
    RECOVERY_ID: 'Email',
    ...
    QUESTION_CHILDHOOD_AREA: 'The area I lived as a child?',
    QUESTION_PET_NAME: 'My pet’s name?',
    QUESTION_MOTHER_NAME: 'My mother’s name?',
    QUESTION_ROLE_MODEL: 'Who is my role model?',
  },
  ...
  ja: {
    ...
    PW_RECOVERY: 'パスワード復旧',
    REQUIRED: '必須',
    REQUIRED_ALL: 'すべて入力してください。',
    FORMAT_ERROR: '形式エラー',
    PW_MIN_8: 'パスワードは8文字以上が必要です。',
    NUM_ONLY: '数値のみ入力してください。',
    PROCESSING: '処理中…',
    CREATE_ACCOUNT: 'アカウント作成',
    ALREADY_HAVE_ACCOUNT: 'すでにアカウントがありますか？',
    ERR_WRONG_PW: 'パスワードが違います。',
    ERR_NO_USER: 'ユーザーが見つかりません。',
    ERR_FORBIDDEN: 'アクセス不可。',
    ERR_INVALID_CRED: 'メールまたはパスワードが違います。',
    EMAIL_INVALID: '正しいメール形式ではありません。',
    ...
    RECOVERY: 'パスワード復旧',
    RECOVERY_SETUP: 'セキュリティQ&A',
    SECURITY_QNA: 'セキュリティQ&A',
    SECURITY_QNA_OPTIONAL: 'セキュリティQ&A（任意）',
    SECURITY_DESC_SIGNUP: 'お好きな質問に回答してください。最低2つの登録を推奨します。',
    SECURITY_POLICY: 'パスワード復旧：2問以上。ID復旧：5問すべて必須。5未満の場合はパスワードのみ復旧可。',
    RECOVERY_REGISTER_DESC: '5問のうち少なくとも2問の回答/確認を登録してください。',
    RECOVERY_START_DESC: 'メールを入力すると2問が出題されます。',
    RECOVERY_START_DESC_ID: 'ID復旧には5問すべての回答登録が必要です。',
    RECOVERY_ID: 'メール',
    ...
    QUESTION_CHILDHOOD_AREA: '子どもの頃に住んだ地域は？',
    QUESTION_PET_NAME: 'ペットの名前は？',
    QUESTION_MOTHER_NAME: '母の名前は？',
    QUESTION_ROLE_MODEL: 'あなたのロールモデルは？',
  },
  ...
  zh: {
    ...
    RECOVERY_SETUP: '安全问答',
    SECURITY_QNA: '安全问答',
    SECURITY_QNA_OPTIONAL: '安全问答（可选）',
    SECURITY_DESC_SIGNUP: '从下列问题中任选回答，建议至少登记两项。',
    SECURITY_POLICY: '找回密码：至少2个答案。找回ID：5个答案全部必需。少于5个只能找回密码。',
    RECOVERY_REGISTER_DESC: '5个问题中至少登记2个的答案/确认。',
    RECOVERY_START_DESC: '输入邮箱后将出现2个问题。',
    RECOVERY_START_DESC_ID: '找回ID需要登记所有5个问题的答案。',
    RECOVERY_ID: '邮箱',
    RECOVERY_START: '获取问题',
    ...
    QUESTION_CHILDHOOD_AREA: '我童年居住的地方？',
    QUESTION_PET_NAME: '我的宠物名字？',
    QUESTION_MOTHER_NAME: '我母亲的名字？',
    QUESTION_ROLE_MODEL: '我的榜样是谁？',
  },
};
