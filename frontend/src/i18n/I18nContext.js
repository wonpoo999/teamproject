...
const DICT = {
  ko: {
    ...
    // 테마/탭
    DARK:'다크', LIGHT:'라이트', PROFILE:'프로필', SETTINGS:'설정', RANKING:'랭킹',
    QUEST:'퀘스트',
    // 홈 카드
    FOOD_LOG:'식단 기록',
    AT_A_GLANCE:'한눈에',
    ...
    ATTENDANCE:'출석',
    FIRST_DAY:'첫날',
    CUM_LOGIN_DAYS:'통산 로그인 일자',
    CONSEC_LOGIN_DAYS:'연속 로그인 일자',
    COINS:'코인',
    INFO:'정보',
    COIN_INFO:'코인 보너스 정보',
    NEXT_LOGIN_BONUS:'다음 통산 로그인 보너스까지 앞으로',
    ...
    CLOSE:'닫기',
    // 설정 화면
    LANGUAGE:'LANGUAGE', SFX:'SFX', VOICE:'보이스', VOICE_SELECT:'보이스 선택', VOICE_CURRENT:'현재: 기본 보이스',
    LOG_OUT:'로그아웃',
    // 보이스
    VOICE_PICK:'보이스 선택', USE_DEFAULT_VOICE:'기본 보이스 사용', PREVIEW:'미리듣기',
    SELECT:'선택', ALL:'전체',
    // 퀘스트
  ...
  en: {
    ...
    FOOD_LOG:'Food log', AT_A_GLANCE:'Overview', HOME_MEAL:'Food log', HOME_DATA:'Overview',
    HOME_OVERALL:'Overview',
    ATTENDANCE:'Attendance', FIRST_DAY:'First day',
    CUM_LOGIN_DAYS:'Cumulative login days',
    CONSEC_LOGIN_DAYS:'Consecutive login days',
    COINS:'Coins', INFO:'Info', COIN_INFO:'Coin bonus info',
    NEXT_LOGIN_BONUS:'Until next cumulative login bonus',
    ...
    QUESTION_BIRTHPLACE:'Where was I born?', QUESTION_CHILDHOOD_AREA:'The area I lived as a child?',
    QUESTION_PET_NAME:'My pet’s name?', QUESTION_MOTHER_NAME:'My mother’s name?', QUESTION_ROLE_MODEL:'Who is my role model?',
    LANG_KO_NATIVE:'한국어', LANG_EN_NATIVE:'English', LANG_JA_NATIVE:'日本語', LANG_ZH_NATIVE:'中文',
  },
  ja: {
    ...
    ERR_WRONG_PW:'パスワードが違います。', ERR_NO_USER:'ユーザーが見つかりません。', ERR_FORBIDDEN:'アクセス不可。',
    ERR_INVALID_CRED:'メールまたはパスワードが違います。', EMAIL_INVALID:'正しいメール形式ではありません。',
    PW_TOO_SHORT:'新しいパスワードは8文字以上が必要です。', PW_MISMATCH:'パスワード確認が一致しません。',
    UPDATE_OK:'更新が完了しました。', UPDATE_FAIL:'更新に失敗しました。', TRY_LATER:'後でもう一度お試しください。',
    ...
    DARK:'ダーク', LIGHT:'ライト', PROFILE:'プロフィール', SETTINGS:'設定', RANKING:'ランキング', QUEST:'QUEST',
    FOOD_LOG:'食事記録', AT_A_GLANCE:'ひと目で', HOME_MEAL:'食事記録', HOME_DATA:'ひと目で',
    HOME_OVERALL:'概要',
    ATTENDANCE:'出席', FIRST_DAY:'初日',
    CUM_LOGIN_DAYS:'通算ログイン日数',
    CONSEC_LOGIN_DAYS:'連続ログイン日数',
    COINS:'コイン', INFO:'情報', COIN_INFO:'コインボーナス情報',
    ...
    CLOSE:'閉じる',
    LANGUAGE:'LANGUAGE', SFX:'SFX', VOICE:'ボイス', VOICE_SELECT:'ボイス選択', VOICE_CURRENT:'現在のボイス',
    LOG_OUT:'ログアウト',
    ...
    QUESTION_BIRTHPLACE:'生まれた場所は？', QUESTION_CHILDHOOD_AREA:'子どもの頃に住んだ地域は？', QUESTION_PET_NAME:'ペットの名前は？',
    QUESTION_MOTHER_NAME:'母の名前は？', QUESTION_ROLE_MODEL:'あなたのロールモデルは？',
    LANG_KO_NATIVE:'한국어', LANG_EN_NATIVE:'English', LANG_JA_NATIVE:'日本語', LANG_ZH_NATIVE:'中文',
  },
  zh: {
    ...
    FIND_ID:'找回ID', PW_RECOVERY:'找回密码', REQUIRED:'必填', REQUIRED_ALL:'请填写所有项目。',
    FORMAT_ERROR:'格式错误', PW_MIN_8:'密码至少需要8位。', NUM_ONLY:'请输入数字。', PROCESSING:'处理中…',
    ...
    DARK:'深色', LIGHT:'浅色', PROFILE:'个人资料', SETTINGS:'设置', RANKING:'排行榜', QUEST:'QUEST',
    FOOD_LOG:'饮食记录', AT_A_GLANCE:'一目了然', HOME_MEAL:'饮食记录', HOME_DATA:'一目了然',
    HOME_OVERALL:'总览',
    ATTENDANCE:'出勤', FIRST_DAY:'第一天',
    CUM_LOGIN_DAYS:'累计登录天数',
    CONSEC_LOGIN_DAYS:'连续登录天数',
    COINS:'硬币', INFO:'信息', COIN_INFO:'硬币奖励信息',
    ...
    CLOSE:'关闭',
    LANGUAGE:'LANGUAGE', SFX:'SFX', VOICE:'语音', VOICE_SELECT:'语音选择', VOICE_CURRENT:'当前语音',
    LOG_OUT:'退出登录',
    ...
    ANSWER:'答案', ANSWER_CONFIRM:'确认', QUESTION_BIRTHPLACE:'我出生在？',
    QUESTION_CHILDHOOD_AREA:'我童年居住的地方？', QUESTION_PET_NAME:'我的宠物名字？',
    QUESTION_MOTHER_NAME:'我母亲的名字？', QUESTION_ROLE_MODEL:'我的榜样是谁？',
    LANG_KO_NATIVE:'한국어', LANG_EN_NATIVE:'English', LANG_JA_NATIVE:'日本語', LANG_ZH_NATIVE:'中文',
  },
};
